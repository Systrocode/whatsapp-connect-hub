...
const renderFeatureVisual = (title: string, Icon: any, visualType?: string, description?: string) => {
    ...
    return (
        <div className="w-full h-full bg-white dark:bg-slate-950 rounded-2xl shadow-lg flex flex-col overflow-hidden relative max-w-[80%] mx-auto transition-transform hover:scale-[1.02] duration-500">
            ...
            {/* Floating Badge */}
            <div className="absolute bottom-6 right-6 bg-white dark:bg-slate-800 p-3 rounded-xl shadow-xl border border-slate-100 dark:border-slate-700 flex items-center gap-3 animate-bounce">
                ...
                <div className="container mx-auto max-w-7xl">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            {/* Floating App Icons */}
                            <motion.div className="absolute bottom-20 left-0 bg-white p-2 rounded-2xl shadow-xl z-20 animate-bounce">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/6/6b/WhatsApp.svg" className="w-10 h-10" alt="WA" />
                            </motion.div>
                            <motion.div className="absolute bottom-32 left-[-40px] bg-white p-2 rounded-2xl shadow-xl z-10 animate-pulse">
                                <img src="/logos/instagram.svg" className="w-8 h-8" alt="Insta" />
                            </motion.div>
                            <motion.div className="absolute bottom-40 left-16 bg-white p-2 rounded-full shadow-xl z-30 animate-bounce delay-100">
