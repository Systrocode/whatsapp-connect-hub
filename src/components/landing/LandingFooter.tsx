...
import { MessageSquare, Twitter, Linkedin, Facebook, Instagram, Apple, Play } from "lucide-react";
        ...
        <div className="bg-white dark:bg-background pt-20 pb-4">
            ...
            <div className="text-center mb-16 px-4">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <button className="px-8 py-4 rounded-full border-2 border-slate-900 dark:border-white text-slate-900 dark:text-white font-bold text-lg hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors w-full sm:w-auto">
                        Book a Demo
                    </button>
                    <button className="px-8 py-4 rounded-full bg-green-500 text-white font-bold text-lg hover:bg-green-600 transition-colors shadow-xl hover:shadow-green-500/25 w-full sm:w-auto">
                        Try for Free
                    </button>
                </div>
            </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-y-12 gap-x-8 mb-20">
                        ...
                        <div className="space-y-10">
                            <div>
                                ...
                                <ul className="space-y-4 text-sm font-medium">
                                    <li><Link to="#" className="text-slate-300 hover:text-green-400 transition-colors">Marketing</Link></li>
                                    <li><Link to="#" className="text-slate-300 hover:text-green-400 transition-colors">Support</Link></li>
                                    <li><Link to="#" className="text-slate-300 hover:text-green-400 transition-colors">Sales</Link></li>
                                    <li><Link to="#" className="text-slate-300 hover:text-green-400 transition-colors">Education</Link></li>
                                    <li><Link to="#" className="text-slate-300 hover:text-green-400 transition-colors">E-Commerce</Link></li>
                                </ul>
                            </div>
                            <div>
                                ...
                                <ul className="space-y-4 text-sm font-medium">
                                    ...
                                    <li><Link to="/legal" className="text-slate-300 hover:text-green-400 transition-colors">Terms & Privacy</Link></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="space-y-10">
                            <div>
                                ...
                                <ul className="space-y-4 text-sm font-medium">
                                    <li><Link to="#" className="text-slate-300 hover:text-green-400 transition-colors">Client Stories</Link></li>
                                    <li><Link to="#" className="text-slate-300 hover:text-green-400 transition-colors">Reviews</Link></li>
                                    <li><Link to="#" className="text-slate-300 hover:text-green-400 transition-colors">Case Studies</Link></li>
                                </ul>
                            </div>
                            <div>
                                <h3 className="text-green-500 font-bold mb-6 text-lg">Partner</h3>
                                <ul className="space-y-4 text-sm font-medium">
                                    <li><Link to="#" className="text-slate-300 hover:text-green-400 transition-colors">Become a Partner</Link></li>
                                    <li><Link to="#" className="text-slate-300 hover:text-green-400 transition-colors">Affiliate Program</Link></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="w-full lg:w-auto">
                            ...
                            <div className="flex flex-wrap items-center gap-8 opacity-60 hover:opacity-100 transition-opacity">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-slate-300 font-semibold text-sm">Tech Partner</span>
                                </div>
                                <div className="flex items-center gap-3">
                                    <img src="/logos/google-ads.svg" alt="Google" className="h-6 w-auto" />
                                    <span className="text-slate-300 font-semibold text-sm">Partner</span>
                                </div>
                            </div>
                        </div>
